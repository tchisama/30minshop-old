  ...
  return (
    <div className='text-gray-600'>
        ...
        <div className='py-4'>
            ...
            <textarea className='w-full outline-blue-300 rounded-lg px-4 py-2 bg-white border' value={data[selectedSection||0].props.h1Text} onInput={(e)=>setData(data.map((s,i)=>i==selectedSection?{...s,props:{...s.props,h1Text:e.target.value}}:s))}/>
            <div className='flex justify-between items-center '>
            ...
            <textarea className='w-full outline-blue-300 rounded-lg px-4 py-2 bg-white border' value={data[selectedSection||0].props.h3Text} onInput={(e)=>setData(data.map((s,i)=>i==selectedSection?{...s,props:{...s.props,h3Text:e.target.value}}:s))}/>
            ...
            <input className='w-full  outline-blue-300 rounded-lg px-4 py-2 bg-white border' value={data[selectedSection||0].props.imageUrl} onInput={(e)=>setData(data.map((s,i)=>i==selectedSection?{...s,props:{...s.props,imageUrl:e.target.value}}:s))}/>
        </div>
